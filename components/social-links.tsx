...
export default function SocialLinks() {
  return (
    <div className="hidden fixed right-24 bottom-0 lg:flex flex-col w-6 h-[11rem] items-center justify-between">
      ...
      <div className="w-36 h-1 bg-secondary-foreground rotate-90"></div>
    </div>
  );
}
